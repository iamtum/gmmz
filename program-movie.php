...
<div id="wrapper">
  ...
  <?php include('inc/inc-header.php'); ?>
	...
	<div id="contents">
		<div class="section">
        	<div id="series">
            	<h1>ภาพยนต์/Movies</h1>
            	<p><img src="images/pic_program04.gif" width="978" height="345" alt="" /></p> 
            <!-- / #series --></div>
        <!-- /section --></div>
        <div class="section">
		...
		<div id="varietyWrap" class="section">
          	<div id="variety">
            	...
            	<div id="slider" class="slides">
                  <img src="images/pic_varietySlide03.gif" width="695" height="330" alt="" />           		  
                  <img src="images/pic_varietySlide03.gif" width="695" height="330" alt="" />           		  
                  <img src="images/pic_varietySlide03.gif" width="695" height="330" alt="" />           		  
                </div>
              	<div class="categoryWrap">
                	<ul id="categories">
                		<li><a href="#">ภาพยนตร์/Movies </a></li>
                		<li><a href="#">ซีรีส์/Series</a></li>
