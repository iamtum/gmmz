	...
	<div id="contents">
		<div class="section">
        	<div id="series">
            	...
            	<p><img src="images/pic_program05.gif" width="978" height="345" alt="" /></p> 
            <!-- / #series --></div>
        <!-- /section --></div>
        <div class="section">
		...
		<div id="varietyWrap" class="section">
          	<div id="variety">
        		<p class="heading">ซีรีส์/Series</p>
            	<div id="slider" class="slides">
              	...
              	<div class="categoryWrap">
                	<ul id="categories">
                		...
                		<li class="current"><a href="#">ซีรีส์/Series</a></li>
                		<li><a href="#">กีฬา/Sport </a></li>
                		<li><a href="#">สารคดี/Documentary</a></li>
